...
--
-- Хост: mysql
-- Время создания: Янв 22 2023 г., 15:15
...
INSERT INTO `client` (`id`, `name`, `birth`, `phone`) VALUES
(13, 'Иванов И.И.', '2003-01-01', '89123456789'),
(14, 'Алексеев А.А.', '1995-01-20', '89123456745'),
(15, 'Антонов В.В.', '1996-05-17', '89123456678'),
(16, 'Тигранов А.В.', '1993-01-28', '89995557788'),
(17, 'Сулейманов И.В.', '1995-01-23', '89967773553'),
(18, 'Салманов В.И.', '1991-03-08', '89928887766');
...
INSERT INTO `payment` (`id`, `id_client`, `sum`, `status`, `type`) VALUES
(1, 13, 6000, 1, 1),
(2, 13, 2500, 2, 1),
(3, 14, 10000, 2, 1),
(4, 14, 5000, 1, 1);
...
(15, '2023-01-06 09:00:00', '19:00:00', 13, 3, 3);
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `client` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
