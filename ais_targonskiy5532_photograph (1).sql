...
--
-- Хост: mysql
-- Время создания: Янв 15 2023 г., 22:42
...
(3, 'Иванов И.И.', '2012-09-06', '89123456789'),
(4, 'Николаев Н.Н.', '2023-01-01', '89123456123'),
(5, 'Алексеев А.А.', '2023-01-04', '89123456745'),
(6, 'Антонов В.В.', '2020-01-02', '89123456678');
...
CREATE TABLE `visit` (
  `id` int NOT NULL,
  `date/time` datetime NOT NULL COMMENT 'Дата фотосессии',
